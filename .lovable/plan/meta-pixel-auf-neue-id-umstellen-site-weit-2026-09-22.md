...
- Das `fbq("track", "Lead")` wird beim Klick auf „Bewerbung senden“ ausgelöst, sobald die Pflichtfelder gültig sind und der Versand startet. So zählt der Klick genau einmal; ein Klick mit fehlenden Pflichtangaben zählt nicht als Lead.
...
- Playwright-Prüfung: `fbq` ist auf Startseite und Bewerbungsseite global initialisiert, fbevents.js wird geladen, kein doppeltes `init`, ein gültiger Absende-Klick löst genau ein `Lead`-Event aus und es gibt keinen Console-Error.
