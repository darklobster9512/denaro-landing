...
function ImpressumPage() {
  return <>
    ...
    <section className="py-12 md:py-28"><div className="site-container grid gap-8 lg:grid-cols-12 lg:gap-10"><aside className="lg:col-span-3"><p className="eyebrow text-primary">Anbieterkennzeichnung</p><p className="mt-5 text-sm leading-7 text-muted-foreground">Rechtliche Informationen zur Denaro Consulting GmbH.</p></aside><div className="border-t border-border leading-8 lg:col-span-8 lg:col-start-5 [&>div]:grid [&>div]:border-b [&>div]:border-border [&>div]:py-6 md:[&>div]:py-8 md:[&>div]:grid-cols-[3rem_1fr] md:[&>div]:gap-7">
      ...
      <div><span className="text-xs font-bold text-primary">03</span><div><h2 className="font-display text-xl font-extrabold">Kontakt</h2><p className="mt-2 text-muted-foreground">Telefon: <a className="tap-target text-primary underline" href="tel:+4921187971210">0211 87971210</a><br />E-Mail allgemein: <a className="tap-target text-primary underline" href="mailto:kontakt@denaro-consult.com">kontakt@denaro-consult.com</a><br />Geschäftsführung: <a className="tap-target text-primary underline" href="mailto:geschaeftsfuehrung@denaro-consult.com">geschaeftsfuehrung@denaro-consult.com</a><br />Bewerbungen: <a className="tap-target text-primary underline" href="mailto:karriere@denaro-consult.com">karriere@denaro-consult.com</a><br />Internet: denaro-consult.solutions</p></div></div>
